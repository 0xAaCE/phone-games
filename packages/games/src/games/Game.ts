import { FinishRoundParams, FinishRoundResult, GamePlayer, GameState, MiddleRoundActionParams, MiddleRoundActionResult, NextRoundParams, NextRoundResult, ValidGameNames } from "../interfaces/Game";
